...
const MOVABLE = [
  ...
  { c: '香港', n: '清明节', days: [[2026, 4, 5], [2027, 4, 5], [2028, 4, 4]] },
  { c: '香港', n: '耶稣受难节', days: GOOD_FRIDAY },
  { c: '香港', n: '耶稣受难节翌日', days: GOOD_FRIDAY.map(([y, m, d]) => [y, m, d + 1]) },
  { c: '香港', n: '复活节星期一', days: GOOD_FRIDAY.map(([y, m, d]) => [y, m, d + 3]) },
  { c: '香港', n: '佛诞', days: [[2026, 5, 24], [2027, 5, 13], [2028, 5, 2]] },
  { c: '香港', n: '端午节', days: [[2026, 6, 19], [2027, 6, 9], [2028, 5, 28]] },
  { c: '香港', n: '中秋节翌日', days: [[2026, 9, 26], [2027, 9, 16], [2028, 10, 4]] },
  { c: '香港', n: '重阳节', days: [[2026, 10, 18], [2027, 10, 8], [2028, 9, 27]] },
  { c: '新加坡', n: '农历新年', days: CNY.map(([y, m, d]) => [y, m, d, 2]) },
