...
try {
 for(const name of ['manifest.json','newtab.html','privacy.html','LICENSE','js','css','icons','assets/movies','assets/brand-icons'])fs.cpSync(name,path.join(stage,name),{recursive:true});
