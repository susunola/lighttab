...
(function () {
  ...
  const DICT = {
    ...
    'cal.sub_help':   { zh: '只读订阅。事件会以彩色圆点显示在上方日历中，点某一天即可查看详情。', en: 'Read-only. Events show as coloured dots on the calendar above; click a day to see them.' },
    ...
    'gen.name':     { zh: '显示名称', en: 'Display name (used in greeting)' },
    ...
    'gen.version':  { zh: 'LightTab v1.23.1 · 极简新标签页 · 本地优先，可选云同步', en: 'LightTab v1.23.1 · Minimal new tab · Local-first, optional cloud sync' },
    ...
    'toast.cal_host':          { zh: '暂不支持该日历主机，可提 issue 申请适配', en: 'That calendar host is not supported yet — open an issue to request it' },
    ...
    'sync.backups': { zh: '本机恢复备份', en: 'Device recovery backups' },
    'sync.backups_tip': { zh: '仅保存在此浏览器，保留最近 3 份，不包含登录凭据。请下载重要备份；浏览器数据清除后无法恢复。', en: 'Only on this browser. Keeps the latest 3 copies, without sign-in credentials. Download important backups; clearing browser data removes them.' },
    ...
    'sync.export_backup': { zh: '下载完整备份', en: 'Download full backup' },
    'sync.restore_backup': { zh: '恢复到本机', en: 'Restore to device' },
    'sync.delete_backup': { zh: '删除备份', en: 'Delete backup' },
    ...
    'sync.reason.before-login': { zh: '登录同步前', en: 'Before sign-in sync' },
    'sync.reason.before-cloud': { zh: '采用云端更新前', en: 'Before cloud update' },
    'sync.reason.before-choice': { zh: '处理同步差异前', en: 'Before resolving differences' },
    'sync.reason.cloud-copy': { zh: '替换前的云端冲突内容，其余内容为本机副本', en: 'Displaced cloud conflict data; other data is from this device' },
    'sync.reason.before-restore': { zh: '恢复备份前', en: 'Before backup restore' },
    'sync.reason.before-local': { zh: '保存待处理的本机修改前', en: 'Before queued device edit' },
