...
(function () {
  ...
  const DICT = {
    ...
    'page.calendar': { zh: '日历', en: 'Calendar' },
    'page.home':     { zh: '返回主页', en: 'Back to home' },
    ...
    'avatar.upload_hint': { zh: '点击上传头像', en: 'Click to upload' },
    'avatar.change_hint': { zh: '点击更换头像', en: 'Click to change' },
    'avatar.upload':       { zh: '上传头像', en: 'Upload avatar' },
    'avatar.remove':       { zh: '移除', en: 'Remove' },
    'avatar.tip':          { zh: '支持常见图片格式，最大 4MB，自动裁圆。', en: 'Optional: upload a square image as your top-right avatar (PNG/JPG/WebP/GIF, \u22644MB, auto-cropped round). Leave empty to show the name initial or a default icon.' },

    // ---------- Widget titles ----------
    'widget.ai': { zh: 'AI 工具台', en: 'AI assistant' },
    ...
    'cal.view_week': { zh: '周', en: 'Week' },
    'cal.view_month': { zh: '月', en: 'Month' },
    'cal.view_year': { zh: '年', en: 'Year' },
    ...
    'weather.city_ph': { zh: '天气城市', en: 'Weather city' },
    ...
    // --- Subscribed calendars (published ICS feeds) ---
    'cal.sub_title':  { zh: '订阅日历', en: 'Subscribed calendars' },
    'cal.mine':       { zh: '我的事项', en: 'My events' },
    'cal.mine_help':  { zh: '导出后可导入其他日历应用。', en: 'Export to import into other calendar apps.' },
    'cal.mine_export':{ zh: '导出 ICS', en: 'Export ICS' },
    'cal.mine_add':   { zh: '添加', en: 'Add' },
    'cal.mine_new':   { zh: '新建事项', en: 'New event' },
    'cal.mine_del':   { zh: '删除事项', en: 'Delete event' },
    'cal.mine_del_short': { zh: '删除', en: 'Delete' },
    'cal.mine_ph':    { zh: '添加事项…', en: 'Add an event…' },
    'cal.upcoming':   { zh: '接下来', en: 'Upcoming' },
    'cal.manage':     { zh: '去设置管理订阅', en: 'Manage subscriptions in Settings' },
    'cal.upcoming_empty': { zh: '近两周没有订阅日程', en: 'No subscribed events in the next two weeks' },
    'cal.retry':      { zh: '重试同步', en: 'Retry sync' },
    'cal.recolor':    { zh: '更换颜色', en: 'Change colour' },
    'cal.rename':     { zh: '重命名订阅', en: 'Rename feed' },
    'cal.sub_help':   { zh: '粘贴公开 ICS 链接，或导入文件。', en: 'Paste a public ICS link, or import a file.' },
    'cal.url_ph':     { zh: 'https://… 或 webcal://…', en: 'https://… or webcal://…' },
    'cal.add':        { zh: '订阅', en: 'Subscribe' },
    'cal.import_file': { zh: '导入 ICS', en: 'Import ICS' },
    'cal.refresh':    { zh: '立即刷新', en: 'Refresh now' },
    'cal.how':        { zh: '链接去哪找？', en: 'Where do I find the link?' },
    'cal.how_body':   { zh: '<b>苹果日历（iCloud）：</b>打开「日历」→ <b>共享</b>该日历 → 打开<b>公开日历</b> → <b>拷贝链接</b>，粘贴到这里即可（<code>webcal://</code> 开头也可以）。<br><b>Google 日历：</b>设置 → 选择该日历 → <b>日历的私有地址（iCal 格式）</b>。<br><b>Outlook：</b>设置 → 日历 → 共享日历 → <b>发布</b> → 复制 ICS 链接。', en: '<b>Apple Calendar (iCloud):</b> open Calendar → <b>share</b> the calendar → turn on <b>Public Calendar</b> → <b>Copy Link</b>; paste it here (a <code>webcal://</code> link is fine).<br><b>Google Calendar:</b> Settings → select the calendar → <b>Secret address in iCal format</b>.<br><b>Outlook:</b> Settings → Calendar → Shared calendars → <b>Publish</b> → the ICS link.' },
    'cal.privacy_note': { zh: '公开链接是只读的，但不可猜测——它相当于那一份日历的钥匙。链接只存在本机，绝不会上传到云同步服务器。', en: 'Published links are read-only but unguessable — they act like a key to that one calendar. They are stored on this device only and are never uploaded to the cloud sync server.' },
    'cal.empty':      { zh: '还没有订阅任何日历。', en: 'No calendars subscribed yet.' },
    'cal.unnamed':    { zh: '未命名事件', en: 'Untitled event' },
    'cal.all_day':    { zh: '全天', en: 'All day' },
    'cal.no_events':  { zh: '这一天没有日程。', en: 'Nothing scheduled this day.' },
    'cal.events_n':   { zh: '{n} 项日程', en: '{n} events' },
    'cal.close':      { zh: '关闭', en: 'Close' },
    'cal.enable':     { zh: '启用这一订阅', en: 'Enable this feed' },
    'cal.remove':     { zh: '删除这一订阅', en: 'Remove this feed' },
    'cal.status_syncing': { zh: '正在同步…', en: 'Syncing…' },
    'cal.status_never':   { zh: '尚未同步', en: 'Not synced yet' },
    'cal.status_ok':      { zh: '已同步 {n} 项日程', en: '{n} events synced' },
    'cal.status_err':     { zh: '同步失败：{why}', en: 'Sync failed: {why}' },
    'cal.status_fail':    { zh: '有日历未同步成功', en: 'A calendar failed to sync' },
    'cal.status_preview': { zh: '预览页不能在线同步', en: 'Preview cannot sync online' },
    'cal.preview_banner': { zh: '当前是预览页。在线订阅 iCloud 请加载扩展。', en: 'This is the preview page. Load the extension to subscribe to iCloud.' },
    'cal.err_http':       { zh: '服务器返回 {code}', en: 'server returned {code}' },
    'cal.err_timeout':    { zh: '请求超时', en: 'request timed out' },
    'cal.err_network':    { zh: '网络不可达（或该主机未授权）', en: 'unreachable (or host not authorised)' },
    'cal.err_preview':    { zh: '需加载扩展', en: 'Needs the extension' },
    'cal.err_parse':      { zh: '日历格式无法解析', en: 'could not parse the calendar' },
    'cal.err_too_large':  { zh: '日历文件过大', en: 'calendar file too large' },
    ...
    'help.title':   { zh: '键盘快捷键', en: 'Keyboard shortcuts' },
    'help.slash':   { zh: '打开 / 关闭 AI 模板面板', en: 'Open AI template palette' },
    'help.digits':  { zh: '切换到第 n 个搜索引擎', en: 'Switch to the nth search engine' },
    'help.tabcycle':{ zh: '搜索框内循环切换引擎', en: 'Cycle the search engine (in the box)' },
    'help.arrows':  { zh: '选择联想项 / 回车直达', en: 'Pick a suggestion / press Enter' },
    'help.gridkeys':{ zh: '网格中编辑 / 删除聚焦的快捷方式', en: 'Edit / delete the focused shortcut in the grid' },
    'help.todo':    { zh: '聚焦待办输入框', en: 'Focus the to-do input' },
    'help.help':    { zh: '本帮助', en: 'This help' },
    'help.esc':     { zh: '关闭浮层 / 弹窗', en: 'Close overlays / dialogs' },
    ...
    'about.tag':     { zh: '本地优先的新标签页', en: 'Local-first new tab' },
    'about.github':  { zh: '在 GitHub 查看源码', en: 'View source on GitHub' },
    'about.donate':  { zh: '打赏', en: 'Tip the author' },
    'about.donate_tip': { zh: '自愿，不影响现有功能。', en: 'Voluntary. Existing features stay free.' },
    'about.donate_note': { zh: '开发不易，欢迎打赏', en: 'Building this takes time. Tips are welcome.' },
    'about.wechat':  { zh: '微信', en: 'WeChat' },
    'about.alipay':  { zh: '支付宝', en: 'Alipay' },
    'set.general': { zh: '常规', en: 'General' },
    'set.sec_appear': { zh: '外观', en: 'Appearance' },
    'set.sec_search': { zh: '搜索', en: 'Search' },
    'set.prompt':  { zh: '模板', en: 'Templates' },
    'set.calendar': { zh: '日历', en: 'Calendar' },
    ...
    'wall.rotate_tip':{ zh: '每日更新；当天手动选择优先。', en: 'When on, an image from the library is applied each calendar day. Manual picks are kept for the rest of that day.' },
    ...
    // ---------- General tab ----------
    'settings.display': { zh: '时钟与布局', en: 'Clock and layout' },
    'gen.name':       { zh: '名字', en: 'Name' },
    ...
    'engm.add':     { zh: '添加', en: 'Add' },
    'engm.restore': { zh: '恢复内置引擎', en: 'Restore built-in engines' },
    'engm.tip':     { zh: '自定义 URL 需包含 {q} 占位；删除的内置引擎可随时恢复。', en: 'Custom URLs must contain {q} where the query goes. Removed built-ins can be restored at any time.' },
    'engm.del':     { zh: '删除该引擎', en: 'Remove this engine' },
    'engm.deeplink': { zh: '桌面深链', en: 'Desktop deep link' },
    ...
    'toast.tz2_city':   { zh: '没找到这座城市，试试 东京、纽约、伦敦', en: 'City not found — try Tokyo, New York, London' },
    ...
    'gen.import_merge':     { zh: '合并导入(快捷方式)', en: 'Merge shortcuts' },
    ...
    'toast.import_merge_dup':     { zh: '跳过 {n} 个已存在的', en: 'skipped {n} existing' },
    'toast.backup_remind':  { zh: '距上次备份已 {n} 天，建议导出一份备份', en: '{n} days since your last backup — consider exporting one' },
    ...
    'gen.version':  { zh: 'LightTab v1.24.3 · 极简新标签页 · 本地优先，可选云同步', en: 'LightTab v1.24.3 · Minimal new tab · Local-first, optional cloud sync' },
    ...
    'toast.eng_added':     { zh: '搜索引擎已添加', en: 'Search engine added' },
    'toast.eng_removed':   { zh: '搜索引擎已删除', en: 'Search engine removed' },
    'toast.eng_invalid':   { zh: '名称必填，URL 需以 http(s) 开头且包含 {q}', en: 'Name required; URL must start with http(s) and contain {q}' },
    'toast.eng_last':      { zh: '至少保留一个搜索引擎', en: 'Keep at least one search engine' },
    ...
    'toast.cal_added':         { zh: '已订阅，正在拉取日程…', en: 'Subscribed — fetching events…' },
    'toast.cal_imported':      { zh: '已导入 {n} 条日程', en: 'Imported {n} events' },
    'toast.cal_mine_added':    { zh: '已添加事项', en: 'Event added' },
    'toast.cal_ics_exported':  { zh: '已导出 ICS，可导入苹果日历', en: 'ICS exported — import it into Apple Calendar' },
    'toast.cal_removed':       { zh: '已删除该订阅', en: 'Feed removed' },
    'toast.cal_bad_url':       { zh: '这个链接看起来不是有效的日历地址', en: 'That does not look like a valid calendar URL' },
    'toast.cal_dup':           { zh: '这个日历已经订阅过了', en: 'That calendar is already subscribed' },
    'toast.cal_limit':         { zh: '最多订阅 {n} 个日历', en: 'Up to {n} calendars' },
    'toast.cal_host':          { zh: '浏览器未授权访问该日历主机', en: 'The browser has not authorised this calendar host' },
    'toast.cal_denied':        { zh: '未获授权，无法读取该日历', en: 'Permission denied — cannot read that calendar' },
    ...
    // ---------- 云同步 ----------
    'sync.desc':      { zh: '同步快捷方式、待办、设置、壁纸与模板。首次登录前保存本地备份；两边数据不同时由你选择。数据通过 HTTPS 传输，非端到端加密。', en: 'Sync shortcuts, to-dos, settings, wallpaper and templates. A local backup is saved before first sync; you choose when copies differ. HTTPS transport, not end-to-end encryption.' },
    'sync.status.conflict': { zh: '需要选择保留的数据', en: 'Choose which data to keep' },
    'sync.review': { zh: '核对同步差异', en: 'Review sync differences' },
    'sync.review_tip': { zh: '以下数据已暂停同步。展开查看两份内容后选择；操作前会保留备份。预览中的长内容已截短。', en: 'Sync is paused for the data below. Expand both copies before choosing; a backup is saved first. Long preview content is truncated.' },
    'sync.local': { zh: '本机内容', en: 'This device' },
    'sync.cloud': { zh: '云端内容', en: 'Cloud copy' },
    'sync.keep_local': { zh: '保留本机并上传', en: 'Keep device copy and upload' },
    'sync.use_cloud': { zh: '采用云端内容', en: 'Use cloud copy' },
    'sync.deleted': { zh: '此份数据已删除或为空', en: 'This copy is deleted or missing' },
    'sync.empty_list': { zh: '列表为空', en: 'Empty list' },
    'sync.settings_preview': { zh: '称呼：{name}\n语言：{language}\n搜索引擎：{engine}\n分组：{groups}\n选择将应用整份设置，包括布局与外观。', en: 'Name: {name}\nLanguage: {language}\nSearch engine: {engine}\nGroups: {groups}\nChoosing applies all settings, including layout and appearance.' },
    'sync.wallpaper_preview': { zh: '壁纸类型：{type}\n选择将应用这份壁纸设置。原图保存在恢复备份中。', en: 'Wallpaper type: {type}\nChoosing applies this wallpaper. The original is kept in the recovery backup.' },
    'sync.key.settings': { zh: '设置', en: 'Settings' },
    'sync.key.items': { zh: '快捷方式', en: 'Shortcuts' },
    'sync.key.wallpaper': { zh: '壁纸', en: 'Wallpaper' },
    'sync.key.todos': { zh: '待办', en: 'To-dos' },
    'sync.key.prompts': { zh: '提示词模板', en: 'Prompt templates' },
    'sync.backups': { zh: '本机备份', en: 'Local backups' },
    'sync.backups_tip': { zh: '自动保留最近 3 份，可一键恢复。', en: 'Keeps the last 3 copies. Restore with one click.' },
    'sync.no_backups': { zh: '暂时没有恢复备份', en: 'No recovery backups yet' },
    'sync.backup_counts': { zh: '{items} 个顶层快捷方式 · {todos} 项待办 · {prompts} 个模板', en: '{items} top-level shortcuts · {todos} to-dos · {prompts} templates' },
    'sync.export_backup': { zh: '下载', en: 'Download' },
    'sync.restore_backup': { zh: '恢复', en: 'Restore' },
    'sync.delete_backup': { zh: '删除', en: 'Delete' },
    'sync.restore_confirm': { zh: '将此备份恢复到本机？当前内容会先备份，并退出云同步。云端内容不会改变。', en: 'Restore this backup? Current data is backed up first and cloud sync is signed out. Cloud data stays unchanged.' },
    'sync.delete_confirm': { zh: '删除这份本机备份？删除后无法恢复。', en: 'Delete this device backup? This cannot be undone.' },
    'sync.restored': { zh: '已恢复本机备份，并退出云同步', en: 'Device backup restored; cloud sync signed out' },
    'sync.reason.before-login': { zh: '登录前', en: 'Before sign-in' },
    'sync.reason.before-cloud': { zh: '更新前', en: 'Before update' },
    'sync.reason.before-choice': { zh: '同步前', en: 'Before sync' },
    'sync.reason.cloud-copy': { zh: '云端副本', en: 'Cloud copy' },
    'sync.reason.before-restore': { zh: '恢复前', en: 'Before restore' },
    'sync.reason.before-local': { zh: '自动备份', en: 'Automatic backup' },
    'sync.err.backup': { zh: '备份保存失败，已停止覆盖。请下载并删除旧备份、释放空间后重试。', en: 'Backup failed; replacement stopped. Download and delete old backups to free space, then retry.' },
    'sync.err.backup_missing': { zh: '备份已不存在，请刷新列表', en: 'Backup no longer exists; refresh the list' },
    'sync.err.stale': { zh: '内容已发生变化，请重新查看两份数据再选择', en: 'Data changed. Review both copies again before choosing.' },
    'sync.err.response': { zh: '云端返回的数据不完整，已停止本次同步', en: 'Cloud response is invalid; this sync was stopped' },
    ...
    'sync.login_success':  { zh: '已登录，请查看同步状态', en: 'Signed in; check sync status' },
    'sync.resend_sent':    { zh: '验证邮件已重新发送', en: 'Verification email re-sent' },
    'sync.logged_out':     { zh: '已登出', en: 'Logged out' },
    'sync.data_mgmt':      { zh: '数据管理', en: 'Data management' },
    'sync.wipe_local':     { zh: '清除本地同步状态', en: 'Clear local sync state' },
    'sync.wipe_local_done':{ zh: '已清除同步状态，下次同步会重新核对两份数据', en: 'Sync state cleared; the next sync compares both copies again' },
    'sync.delete_password': { zh: '确认当前账号密码', en: 'Confirm current account password' },
    'sync.delete_tip': { zh: '删除云端账号及同步内容，保留本机数据。需要服务端支持。', en: 'Deletes the cloud account and synced content; keeps local data. Requires server support.' },
    'sync.delete_done': { zh: '云端账号已删除，本机数据已保留', en: 'Cloud account deleted; local data retained' },
    'sync.wipe_remote':    { zh: '删除云端账号', en: 'Delete cloud account' },
    'sync.wipe_remote_confirm': { zh: '永久删除当前云端账号及同步数据？本机数据保留，此操作不可恢复。', en: 'Permanently delete this cloud account and synced data? Local data is kept. This cannot be undone.' },
    'sync.err.backend_delete': { zh: '后端暂未提供删除接口，此功能待服务器支持后开放', en: 'Deleting cloud data needs backend support that is not available yet' },
