...
(function () {
  ...
  const DICT = {
    ...
    'sync.wipe_local_done':{ zh: '已清除本地同步状态，下次同步会重新上传', en: 'Local sync state cleared — the next sync re-uploads' },
    'sync.wipe_remote':    { zh: '删除云端数据', en: 'Delete cloud data' },
    'sync.wipe_remote_confirm': { zh: '删除云端全部数据？此操作不可恢复。', en: 'Delete ALL cloud data? This cannot be undone.' },
